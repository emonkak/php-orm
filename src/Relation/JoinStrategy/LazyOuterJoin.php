...
class LazyOuterJoin implements JoinStrategyInterface
{
    ...
    /**
     * @var callable(TOuter,LazyValue<?TInner,TKey>):TResult
     */
     ...
     * @param callable(TOuter,LazyValue<?TInner,TKey>):TResult $resultSelector
    ...
    /**
     * @return callable(TOuter,LazyValue<?TInner,TKey>):TResult
     */
